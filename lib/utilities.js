...
requirejs(['_noodles_string','_noodles_number'],function(_string,_number){
	var _String = _string.String,
		_Number = _number.Number,
		_Template;
define('_noodles_utilities',function(require, exports, module){
/**--Noodles.Utilities--
name:reIdentifier
description: regular expression to determine Identifier worthiness
@type{RegExp}
*/
var reIdentifier = exports.reIdentifier = /[^\d\.\['"\s]{1}.*/;
/**--Noodles.Utilities--
...
*/
var _createSubTemplate = exports.createSubTemplate = function(Template,rawString){
	if(typeof _Template === "undefined") _Template = require('_noodles_template').Template;
	var lineCount = _getLineCount(Template),
