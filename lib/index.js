	...
	if(leftIndex > -1){
		...
		if(rightIndex > -1){
			...
			if(expression.charAt(0) === ' '){ 
				...
				expression = typeof allPlugins[this._tagDelegation[tag]] !== "undefined" ? allPlugins[this._tagDelegation[tag]].handleToken(this, expression) : _parseType(this, expression);
...
@return {*}
*/
var _parstType = exports.parseType = function(_self,input){
	input = input.trim();
