...
requirejs(['./template','./number','./string','./plugin','./utilities','./object','./context'],function(template,number,string,plugin,utilities,object,context){
