...
@return {Template}
*/
var Template = exports.Template = function(objArg,Template){
	...
	if(typeof metData !== 'undefined'){
		...
		while(i--){
			...
			if(reIdentifier.test(name) && meta[2] === '='){
				this._metaData[name] = new Template({rawString:value},this);
			}
		}
	...
	else if(typeof Template !== "undefined" && Template instanceof Noodles.Template){
...
var _createSubTemplate = exports.Utilities.createSubTemplate = function(Template,rawString){
	var lineCount = _getLineCount(Template),
		temp = new Template({rawString:rawString,lineOffset:lineCount},Template);
...
var _Object = exports.Object = function(Template, expression){
	...
	if(error === true){
		_warning(Template,'Invalid object syntax');
		this._skip = true;
		return;
	}
	...
	if(this.olength === 1 && typeof order[0] === "string" && typeof Template._metaData[order[0]] !== "undefined"){
		...
		this.needs = _mergeNeeds({},Template._metaData[order[0]]);
	}
