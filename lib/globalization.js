...
Globalization.prototype.warning = function(string){
	...
	args.shift();
	return (this.warnings[string.toLowerCase()] || string || "") + args.join('');
};
/*--Globalization--
name:error
description:translate warnings
...
Globalization.prototype.error = function(string){
	...
	var args = Array.prototype.slice.call(arguments);
	args.shift();
	return (this.errors[string.toLowerCase()] || string || "") + args.join('');;
};
/*--Globalization--
name:tag
description:translate warnings
...
Globalization.prototype.tag = function(string){
	...
	var args = Array.prototype.slice.call(arguments);
	args.shift();
	return (this.tags[string.toLowerCase()] || string || "") + args.join('');
};
/*--Globalization--
name:error
description:translate warnings
...
Globalization.prototype.other = function(string){
	...
	var args = Array.prototype.slice.call(arguments);
	args.shift();
	return (this.others[string.toLowerCase()] || string || "") + args.join('');
};
/*--Globalization--
name:plugin
...
Globalization.prototype.plugin = function(string){
	...
	var args = Array.prototype.slice.call(arguments);
	args.shift();
	return (this.plugin[string.toLowerCase()] || string || "") + args.join('');
};
/*--Globalization--
name:coreTags
description:coreTags in english
*/
Globalization.prototype.coreTags = require('./config').coretags;
});